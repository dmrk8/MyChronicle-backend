...
def test_allow_origins_defaults_to_localhost():
    settings = Settings(
        env="TEST",
        log_level="DEBUG",
        service_name="TestService",
    ...
    assert settings.allow_origins == "http://localhost:5173"


def test_allow_origins_custom_value():
    settings = Settings(
        env="TEST",
        log_level="DEBUG",
        service_name="TestService",
        ...
        tmdb_api_key="key",
        tmdb_access_token="token",
        allow_origins="https://linazze.com",
    )
    assert settings.allow_origins == "https://linazze.com"
